...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <form action="{{ route('admin.categories.update', $category->id) }}" class="col-md-6" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control col-md-6 @error('image') is-invalid @enderror"
                                   ...
                                   readonly
                            >
                            <img src="{{ asset($category->image) }}" alt="" class="img-uploaded img-thumbnail" width="150">
